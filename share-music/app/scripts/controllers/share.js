...
angular.module('shareMusicApp')
    .controller('ShareCtrl', function ($scope, videoData) {
        ...
        $scope.postVideo = function (iFrameUrl, title, genre, form) {
            $scope.showFormErrors = true;
            if (form.selectGenreField.$valid) {
                let videoObj = {
                    iFrameUrl: iFrameUrl,
                    title: title,
                    genre: genre,
